...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsContext = __webpack_require__(168);
	
	var jsContext = _interopRequireWildcard(_jsContext);
	...
	var App = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"button",
					{ onClick: jsContext.checkContext.bind(this) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AsyncStuff = __webpack_require__(169);
	...
	var App = _react2.default.createClass({
		...
		handleSubmit: function handleSubmit(e) {
			e.preventDefault();
			_AsyncStuff.getWeather.apply(this, this.refs.input.value.split(","));
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getWeather(lat, lon) {
		...
		_axios2.default.get("http://nominatim.openstreetmap.org/reverse?format=json&lat=" + lat + "&lon=" + lon + "&zoom=18&addressdetails=1").then(function (result) {
			_this.setState({
	  ...
	  return new Promise(function executor(resolve, reject) {
	    try {
	      if ((typeof XMLHttpRequest !== 'undefined') || (typeof ActiveXObject !== 'undefined')) {
	        ...
	        __webpack_require__(175)(resolve, reject, config);
