...
/***/ function(module, exports, __webpack_require__) {
	...
	var Parent = _react2.default.createClass({
		...
		changeLastName: function changeLastName(value) {
			this.setState({
				lastName: value
			});
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Child = __webpack_require__(167);
	...
	var App = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				this.state.visible ? _react2.default.createElement(_Child2.default, { value: this.state.value }) : null
			);
		},
	...
	var App = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"button",
					{ onClick: this.callApplyCheck.bind(this) },
					"Check Context via Bind"
				),
				_react2.default.createElement(
					"button",
					{ onClick: this.callApplyCheck.bind(this, 6) },
		...
		callApplyCheck: function callApplyCheck(x) {
			console.log(x);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AsyncStuff = __webpack_require__(168);
	...
	var App = _react2.default.createClass({
		...
		handleSubmit: function handleSubmit(e) {
			...
			(0, _AsyncStuff.pokemon)(this.state.input, this.showPokemon);
		},
		showPokemon: function showPokemon(name) {
			this.setState({
				name: name
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function pokemon(id, cb) {
		_axios2.default.get("http://pokeapi.co/api/v2pokemon/" + id).then(function (response) {
